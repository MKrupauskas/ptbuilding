...
export default class SectionGrid extends React.Component {
    render() {
        ...
        return (
            <section style={this.props.style} id={_.get(section, 'section_id', null)} className={classNames('block', 'block-grid', 'outer', {'has-header': _.get(section, 'title', null) || _.get(section, 'subtitle', null)})}>
              <div className="inner">
